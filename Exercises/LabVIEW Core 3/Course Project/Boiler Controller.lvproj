...
<Project Type="Project" LVVersion="17008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Project Documentation" Type="Folder">
			...
			<Item Name="Queued message handler" Type="Folder">
				<Item Name="loc_access_task_data.png" Type="Document" URL="../documentation/Queued message handler/loc_access_task_data.png"/>
				<Item Name="loc_bundle_new_button_ref.png" Type="Document" URL="../documentation/Queued message handler/loc_bundle_new_button_ref.png"/>
				<Item Name="loc_convert_variant.png" Type="Document" URL="../documentation/Queued message handler/loc_convert_variant.png"/>
				<Item Name="loc_create_two_queues.png" Type="Document" URL="../documentation/Queued message handler/loc_create_two_queues.png"/>
				<Item Name="loc_dequeue_error_case.png" Type="Document" URL="../documentation/Queued message handler/loc_dequeue_error_case.png"/>
				<Item Name="loc_disable_new_button.png" Type="Document" URL="../documentation/Queued message handler/loc_disable_new_button.png"/>
				<Item Name="loc_enqueue_generic_message.png" Type="Document" URL="../documentation/Queued message handler/loc_enqueue_generic_message.png"/>
				<Item Name="loc_enqueue_message_with_data.png" Type="Document" URL="../documentation/Queued message handler/loc_enqueue_message_with_data.png"/>
				<Item Name="loc_enqueue_new_message.png" Type="Document" URL="../documentation/Queued message handler/loc_enqueue_new_message.png"/>
				<Item Name="loc_enqueue_priority_message.png" Type="Document" URL="../documentation/Queued message handler/loc_enqueue_priority_message.png"/>
				<Item Name="loc_exit_message.png" Type="Document" URL="../documentation/Queued message handler/loc_exit_message.png"/>
				<Item Name="loc_message_queue_wire.png" Type="Document" URL="../documentation/Queued message handler/loc_message_queue_wire.png"/>
				<Item Name="loc_new_message_diagram.png" Type="Document" URL="../documentation/Queued message handler/loc_new_message_diagram.png"/>
				<Item Name="loc_new_task_loop.png" Type="Document" URL="../documentation/Queued message handler/loc_new_task_loop.png"/>
				<Item Name="loc_new_task_typedef.png" Type="Document" URL="../documentation/Queued message handler/loc_new_task_typedef.png"/>
				<Item Name="loc_open_msg_queue_typedef.png" Type="Document" URL="../documentation/Queued message handler/loc_open_msg_queue_typedef.png"/>
				<Item Name="loc_queued_message_handler.gif" Type="Document" URL="../documentation/Queued message handler/loc_queued_message_handler.gif"/>
				<Item Name="loc_stop_new_mhl.png" Type="Document" URL="../documentation/Queued message handler/loc_stop_new_mhl.png"/>
				<Item Name="loc_stop_task.png" Type="Document" URL="../documentation/Queued message handler/loc_stop_task.png"/>
				<Item Name="loc_ui_data.png" Type="Document" URL="../documentation/Queued message handler/loc_ui_data.png"/>
				<Item Name="loc_value_change_event.png" Type="Document" URL="../documentation/Queued message handler/loc_value_change_event.png"/>
				<Item Name="noloc_note.png" Type="Document" URL="../documentation/Queued message handler/noloc_note.png"/>
				<Item Name="noloc_tip.png" Type="Document" URL="../documentation/Queued message handler/noloc_tip.png"/>
				<Item Name="Queued Message Handler Documentation.html" Type="Document" URL="../documentation/Queued message handler/Queued Message Handler Documentation.html"/>
			</Item>
		</Item>
		<Item Name="Support VIs" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Notifiers" Type="Folder">
				<Item Name="Create Notifiers.vi" Type="VI" URL="../support/Notifieres/Create Notifiers.vi"/>
				<Item Name="Notifiers.ctl" Type="VI" URL="../support/Notifieres/Notifiers.ctl"/>
				<Item Name="Close Notifiers.vi" Type="VI" URL="../support/Notifieres/Close Notifiers.vi"/>
			</Item>
			...
			<Item Name="Controller to Boiler.vi" Type="VI" URL="../support/Notifieres/Controller to Boiler.vi"/>
		...
		<Item Name="Test vis" Type="Folder">
			<Item Name="Test Harness.vit" Type="VI" URL="../Test vis/Test Harness.vit"/>
			<Item Name="Test-Log Status.vi" Type="VI" URL="../Test vis/Test-Log Status.vi"/>
		</Item>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Main Application" Type="EXE">
				...
				<Property Name="Source[0].itemID" Type="Str">{AA985BAB-70BF-4B80-A494-C5F42BF1ECAD}</Property>
